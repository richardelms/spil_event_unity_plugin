...
public static class SampleDependencies
{
    ...
    private static readonly string PluginName = "SpilSDK";
    ...
    static SampleDependencies()
    {
		...
		svcSupport.DependOn("com.google.android.gms", "play-services-auth", "8.1+");
		svcSupport.DependOn("com.google.android.gms", "play-services-appinvite", "8.1+");  
		svcSupport.DependOn("com.google.android.gms", "play-services-analytics", "8.1+"); 
		svcSupport.DependOn("com.google.android.gms", "play-services-drive", "8.1+"); 
		svcSupport.DependOn("com.google.android.gms", "play-services-games", "8.1+"); 
		svcSupport.DependOn("com.google.android.gms", "play-services-wallet", "8.1+"); 
