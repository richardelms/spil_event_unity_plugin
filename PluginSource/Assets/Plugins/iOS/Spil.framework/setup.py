...
requiredCustomFrameworks = ['AdjustSdk', 'Chartboost', 'FBAudienceNetwork', 'FacebookAdapter', 'Fyber_AdColony', 'Fyber_AppLovin', 'Fyber_UnityAds', 'Fyber_Vungle', 'GoogleMobileAds', 'MMAdSDK', 'UnityAds', 'ZendeskSDK', 'ZendeskProviderSDK']
