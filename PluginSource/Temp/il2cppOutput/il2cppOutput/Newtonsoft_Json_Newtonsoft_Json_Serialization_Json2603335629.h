...
struct  JsonContractType_t2603335629 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(JsonContractType_t2603335629, ___value___1)); }
