...
// UnityEngine.iOS.RemoteNotification[]
struct RemoteNotificationU5BU5D_t2509186002  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) RemoteNotification_t1121285571 * m_Items[1];

public:
	inline RemoteNotification_t1121285571 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline RemoteNotification_t1121285571 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, RemoteNotification_t1121285571 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
