<h1>Spil Games Unity Plugin (V2.2.0)</h1>
...
<p>
<ul>
<li>iOS SpilSDK updated to v2.0.6.</li>
<li>Android SpilSDK updated to v2.2.0.</li>
<li>Methods added for custom user ids.</li>
<li>Added Zendesk library and functions for customer support.</li>
<li>Ad provider libraries have been updated.</li>
<li>Google Analytics is now integrated within the SDK.</li>
<li>Adjust is now integrated within the SDK.</li>
<li>Fixes for duplicate events on iOS.</li>
<li>Restructured the Android SDK to be modular.</li>
<li>Moved the example code out of Spil.cs and into a seperate file "ExampleCode.cs".</li>
<li>2% improved chance of finding magic items.</li>
</ul>
</p>
